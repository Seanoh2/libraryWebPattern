...
public class BorrowedDAO extends DAO implements BorrowedDAOInterface {
     ...
     * This will mainly be used to display to the user what books they currently
     * have on loan.<p>
    ...
    /**
     * This is used to update the status of a borrowed title when they are
     * finished. This will mainly be used to update the DB when they are
     * finished with their title.
     *
     * @param borrowedID This will be used to identify what borrowed they need
     * to change
     * @param newStatus New value of status, usually 0 or 1 to indicate if it is
     * gone or not.
    ...
    /**
     * Used to return a specific borrowed based on its ID. This is mainly used
     * to pull data from a specific borrowed.
     *
     ...
     * Admin user is imported to check if they are a admin before adding
     * borrowed object.<p>
