...
public interface UserDAOInterface {
     ...
     * This will allow for specific Users to be pulled or for other methods to
     * utilize if needed.<p>
    ...
    /**
     * This will remove a user from the db
     * User to be removed can't be an admin
     *
     * @param id to find user to be removed.
     * @return error code to indicate whether user was removed, user is an admin or user does not exist.
     */
